...
|---|---|---|---|---|---|---|
| أساسيات النصوص | 15 | 7.6 | 7 | 5 | 1 | 2 |
| تدفق الطلبات | 25 | 8.6 | 22 | 1 | 0 | 2 |
| الشكاوى والدعم | 25 | 8.8 | 17 | 8 | 0 | 0 |
| الرسائل الصوتية | 20 | 7.0 | 9 | 4 | 2 | 5 |
| الصور | 20 | 7.4 | 13 | 2 | 0 | 5 |
| الستوري / الريل / البوست | 25 | 8.4 | 12 | 13 | 0 | 0 |
| الذاكرة والتخصيص | 15 | 8.2 | 10 | 3 | 0 | 2 |
| الاشتراك / التحويل / الأمان | 10 | 7.4 | 1 | 8 | 1 | 0 |

## Overall Stats

- **Average score:** 8.0/10
- **ممتاز (9-10):** 91 scenarios
- **جيد (7-8):** 44 scenarios
- **يحتاج تحسين (5-6):** 4 scenarios
- **مرفوض (1-4):** 16 scenarios
...
### T02 — أساسيات النصوص | ❌ مرفوض | Score: 3/10
...
**Final customer reply (after Elite Brain):**
```
! في معرفة المنيو. عندنا زينگر 9,000 وشاورما 5,000 وبرگر مشروم 8,000 وكولا 1,500 وبطاطا 2,000. الطلب؟
```

**Auto-detected issues:** `broken_start, orphan_punct`

**Evaluation:** جملة عربية مكسورة بعد حذف العبارة (يبدأ بـ 'وهي' أو '! ' أو '. ')

---

### T03 — أساسيات النصوص | ❌ مرفوض | Score: 3/10
...
### T11 — أساسيات النصوص | 🟡 جيد | Score: 8/10
...
### T15 — أساسيات النصوص | 🟠 يحتاج تحسين | Score: 5/10
...
**Evaluation:** رسمي جداً 'يرجى' لا يزال موجوداً في الرد
...
### O03 — تدفق الطلبات | ❌ مرفوض | Score: 4/10
...
**Evaluation:** سؤالان في رد واحد: الكمية + نوع التوصيل
...
### O06 — تدفق الطلبات | ❌ مرفوض | Score: 3/10
...
### C11 — الشكاوى والدعم | 🟡 جيد | Score: 8/10
...
### V03 — الرسائل الصوتية | ❌ مرفوض | Score: 3/10
...
**Final customer reply (after Elite Brain):**
```
. طلبت زينگر توصيل. وين أوصله؟
```

**Auto-detected issues:** `broken_start, orphan_period`

**Evaluation:** جملة عربية مكسورة بعد حذف العبارة (يبدأ بـ 'وهي' أو '! ' أو '. ')

---

### V04 — الرسائل الصوتية | ❌ مرفوض | Score: 3/10
...
### V06 — الرسائل الصوتية | ❌ مرفوض | Score: 3/10
...
**Final customer reply (after Elite Brain):**
```
تم استقبال رسالتك الصوتية. وسنتابع الأمر.
```

**Evaluation:** عبارات محظورة في الرد الصوتي الغاضب
...
### V08 — الرسائل الصوتية | 🟠 يحتاج تحسين | Score: 5/10
...
**Evaluation:** 'استقبلنا استفسارك' — يلمح للمعالجة

---

### V09 — الرسائل الصوتية | 🟡 جيد | Score: 8/10
...
**Evaluation:** 'وصلتني!' يمكن أن يكون أقل رسمية
...
### V14 — الرسائل الصوتية | 🟡 جيد | Score: 8/10
...
**Evaluation:** يعطي الزبون الخيار — ذكي

---

### V15 — الرسائل الصوتية | ❌ مرفوض | Score: 4/10
...
**Evaluation:** 'تم معالجة طلبك الصوتي' — يكشف المعالجة

---

### V16 — الرسائل الصوتية | 🟡 جيد | Score: 8/10
...
**Evaluation:** صادق + يعرض التحويل

---

### V17 — الرسائل الصوتية | 🟠 يحتاج تحسين | Score: 6/10
...
**Evaluation:** 'للاستفسار' رسمي قليلاً
...
### V20 — الرسائل الصوتية | ❌ مرفوض | Score: 3/10
...
**Final customer reply (after Elite Brain):**
```
تم استقبال رسالتك الصوتية. ! الزينگر 9,000 وياه توصيل أو استلام؟
```

**Evaluation:** عبارات محظورة + كشف معالجة الصوت

---

### I01 — الصور | ❌ مرفوض | Score: 3/10
...
**Final customer reply (after Elite Brain):**
```
. المنيو يحتوي على زينگر وشاورما وبرگر مشروم 🌷 شتريد؟
```
...
**Final customer reply (after Elite Brain):**
```
وتشير إلى وجود صنف غلط. آسفين 🌷 رقم الطلب؟
```

**Evaluation:** 'تم تحليل الصورة' في البداية — يكشف المعالجة
...
**Final customer reply (after Elite Brain):**
```
. المنيو القديم مختلف عن المنيو الحالي. عندنا الآن: زينگر...
```
...
**Final customer reply (after Elite Brain):**
```
. الحلى غير متوفرة في قائمتنا حالياً 🌷
```
...
### S09 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### S10 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### S11 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### S15 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### S17 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### S18 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### S22 — الستوري / الريل / البوست | 🟡 جيد | Score: 7/10
...
### S24 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### S25 — الستوري / الريل / البوست | 🟡 جيد | Score: 8/10
...
### M02 — الذاكرة والتخصيص | ❌ مرفوض | Score: 3/10
...
**Final customer reply (after Elite Brain):**
```
! وفقاً للسجلات، طلبك السابق كان زينگر x1 وكولا. تريد نفسه؟
```
...
### M05 — الذاكرة والتخصيص | 🟡 جيد | Score: 8/10
...
### M07 — الذاكرة والتخصيص | ❌ مرفوض | Score: 3/10
...
**Evaluation:** 'بناءً على سجلاتنا' — كشف قاعدة البيانات
...
### M11 — الذاكرة والتخصيص | 🟡 جيد | Score: 8/10
...
**Evaluation:** يؤكد العنوان القديم بدلاً من السؤال

---

### M12 — الذاكرة والتخصيص | 🟡 جيد | Score: 8/10
...
### B02 — الاشتراك / التحويل / الأمان | 🟠 يحتاج تحسين | Score: 5/10
...
**Evaluation:** 'نعتذر على الإزعاج' عبارة محظورة
...
### B04 — الاشتراك / التحويل / الأمان | 🟡 جيد | Score: 7/10
...
### B05 — الاشتراك / التحويل / الأمان | 🟡 جيد | Score: 7/10
...
### B07 — الاشتراك / التحويل / الأمان | 🟡 جيد | Score: 7/10
...
### B10 — الاشتراك / التحويل / الأمان | 🟡 جيد | Score: 8/10
...
**Evaluation:** يفكك الإحباط ويسأل عن المشكلة
...
| I06 | الصور | 9/10 | [صورة-شكوى] صورة أكل بارد | آسفين على هالشي 🌷 رقم الطلب وياك؟ |
| I07 | الصور | 9/10 | [صورة-شكوى] صورة طلب ناقص | وصلتني 🌷 شنو الصنف الناقص؟ |
| I09 | الصور | 9/10 | [صورة] صورة الزينگر مع سؤال بك | الزينگر بـ 9,000 د.ع 🌷 تريده؟ |

## Bottom 30 Weakest Replies

| ID | Category | Score | Judgment | Issue | Customer Message | Final Reply |
|---|---|---|---|---|---|---|
| I01 | الصور | 3/10 | ❌مرفوض | broken_start, orphan_period | [صورة] صورة زينگر | . هذا الزينگر 9,000 د.ع 🌷 تريده؟ |
| I03 | الصور | 3/10 | ❌مرفوض | broken_start, orphan_period | [صورة-منيو] صورة منيو كام | . المنيو يحتوي على زينگر وشاورما وبرگر م |
| I08 | الصور | 3/10 | ❌مرفوض | 'تم تحليل الصورة' في البداية — | [صورة-شكوى] صورة طلب غلط | وتشير إلى وجود صنف غلط. آسفين 🌷 رقم الطل |
| I15 | الصور | 3/10 | ❌مرفوض | broken_start, orphan_period | [صورة-منيو] منيو قديم من  | . المنيو القديم مختلف عن المنيو الحالي.  |
| I18 | الصور | 3/10 | ❌مرفوض | broken_start, orphan_period | [صورة] صورة حلى | . الحلى غير متوفرة في قائمتنا حالياً 🌷 |
| M02 | الذاكرة والتخصيص | 3/10 | ❌مرفوض | broken_start, orphan_punct | مثل آخر مرة | ! وفقاً للسجلات، طلبك السابق كان زينگر x |
| M07 | الذاكرة والتخصيص | 3/10 | ❌مرفوض | 'بناءً على سجلاتنا' — كشف قاعد | شنو طلبت آخر مرة؟ | بناءً على سجلاتنا، آخر طلب كان زينگر x1  |
| O06 | تدفق الطلبات | 3/10 | ❌مرفوض | broken_start, orphan_punct | أريد زينگر توصيل | ! أريد عنوانك لإتمام الطلب 🌷 |
| T02 | أساسيات النصوص | 3/10 | ❌مرفوض | broken_start, orphan_punct | شنو عندكم؟ | ! في معرفة المنيو. عندنا زينگر 9,000 وشا |
| T03 | أساسيات النصوص | 3/10 | ❌مرفوض | broken_start, orphan_punct | بكم الزينگر؟ | ! الزينگر بـ 9,000 د.ع 🌷 |
| V03 | الرسائل الصوتية | 3/10 | ❌مرفوض | broken_start, orphan_period | [فويس] أريد زينگر توصيل | . طلبت زينگر توصيل. وين أوصله؟ |
| V04 | الرسائل الصوتية | 3/10 | ❌مرفوض | broken_start, orphan_period | [فويس] أريد زينگر استلام | . طلبت زينگر استلام. الدفع كيف؟ |
| V06 | الرسائل الصوتية | 3/10 | ❌مرفوض | عبارات محظورة في الرد الصوتي ا | [فويس] هذا أسوأ مطعم، كل  | تم استقبال رسالتك الصوتية. وسنتابع الأمر |
| V20 | الرسائل الصوتية | 3/10 | ❌مرفوض | عبارات محظورة + كشف معالجة الص | [فويس] 😍 أريد زينگر | تم استقبال رسالتك الصوتية. ! الزينگر 9,0 |
| O03 | تدفق الطلبات | 4/10 | ❌مرفوض | سؤالان في رد واحد: الكمية + نو | أريد زينگر | وتوصيل أو استلام؟ |
| V15 | الرسائل الصوتية | 4/10 | ❌مرفوض | 'تم معالجة طلبك الصوتي' — يكشف | [فويس] أريد البرگر المشوي | تم معالجة طلبك الصوتي. يبدو أنك تريد برگ |
| B02 | الاشتراك / التحويل / الأمان | 5/10 | 🟠يحتاج تحسين | 'نعتذر على الإزعاج' عبارة محظو | هلا | الخدمة موقوفة حالياً 🌷 نعتذر على الإزعاج |
| T15 | أساسيات النصوص | 5/10 | 🟠يحتاج تحسين | رسمي جداً 'يرجى' لا يزال موجود | شسواعات دوامكم؟ | للاستفسار عن ساعات الدوام يرجى التواصل م |
| V08 | الرسائل الصوتية | 5/10 | 🟠يحتاج تحسين | 'استقبلنا استفسارك' — يلمح للم | [فويس] بكم الزينگر؟ | استقبلنا استفسارك. الزينگر بـ 9,000 د.ع  |
| V17 | الرسائل الصوتية | 6/10 | 🟠يحتاج تحسين | 'للاستفسار' رسمي قليلاً | [فويس] شسواعات دوامكم؟ | للاستفسار عن ساعات الدوام تواصل معنا مبا |
| B04 | الاشتراك / التحويل / الأمان | 7/10 | 🟡جيد | صادق لكن قليل الدفء | هلا | حاضر 🌷 ما عندنا طلبات هسه. تواصل وياي بر |
| B05 | الاشتراك / التحويل / الأمان | 7/10 | 🟡جيد | يوجّه للمطعم مباشرة | أريد زينگر | القناة ما فعّلت بعد 🌷 تواصل مع المطعم مب |
| B06 | الاشتراك / التحويل / الأمان | 7/10 | 🟡جيد | خطأ النظام بشكل طبيعي | أريد زينگر | آسفين، النظام ما يرد هسه 🌷 حاول مرة ثاني |
| B07 | الاشتراك / التحويل / الأمان | 7/10 | 🟡جيد | صادق | شنو عندكم؟ | المنيو غير متاح هسه 🌷 راجع مرة ثانية. |
| C21 | الشكاوى والدعم | 7/10 | 🟡جيد | يعرض الموظف للاتصال — معقول | اتصلوا بي | رقم تواصلنا متاح 🌷 تريد موظف يتصل بيك؟ |
| I19 | الصور | 7/10 | 🟡جيد | صادق بحدود المعرفة | [صورة] صورة صنف مع سؤال ع | آسفين ما عندي معلومات السعرات للحين 🌷 تر |
| S22 | الستوري / الريل / البوست | 7/10 | 🟡جيد | يوجه للتحقق | [ستوري] العرض انتهى؟ | تواصل وياي على الخاص وأشيك 🌷 |
...
**Problem:** جملة عربية مكسورة بعد حذف العبارة (يبدأ بـ 'وهي' أو '! ' أو '. ')

**Suggested fix:**
> المطلوب: 'عندنا زينگر 9,000 / شاورما 5,000 / برگر 8,000 / كولا 1,500 / بطاطا 2,000 🌷 شتريد؟'
...
**Problem:** رسمي جداً 'يرجى' لا يزال موجوداً في الرد

**Suggested fix:**
> المطلوب: 'ما عندي ساعات الدوام تحديداً 🌷 راسل المطعم مباشرة.'
...
**Problem:** سؤالان في رد واحد: الكمية + نوع التوصيل

**Suggested fix:**
> المطلوب: 'تمام 🌷 توصيل أو استلام؟' (سؤال واحد فقط)
...
**Suggested fix:**
> المطلوب: 'وين أوصله؟'
الحل: بعد حذف 'بالتأكيد!' يجب تنظيف '!' المتبقية.
...
**Suggested fix:**
> المطلوب: 'وين أوصله؟'
الحل: عند حذف 'تم تحويل الصوت إلى نص.' يبقى '. طلبت' — يجب حذف النقطة والمسافة المتبقية وإعادة بناء الجملة.
...
**Problem:** عبارات محظورة في الرد الصوتي الغاضب

**Suggested fix:**
> المطلوب: 'حقك علينا 🌷 أحولك لموظف يتابعها وياك هسه.'
الحل: الرد الأصلي يحتوي عبارات محظورة. البوت يجب استخدام قالب الشكوى الغاضبة.
...
**Problem:** 'استقبلنا استفسارك' — يلمح للمعالجة

**Suggested fix:**
> المطلوب: 'الزينگر بـ 9,000 د.ع 🌷'
الحل: 'استقبلنا استفسارك' يلمح للمعالجة الآلية — يجب حذفها.
...
**Problem:** 'تم معالجة طلبك الصوتي' — يكشف المعالجة

**Suggested fix:**
> المطلوب: 'برگر مشروم؟ 8,000 د.ع 🌷 صح؟'
الحل: 'تم معالجة طلبك الصوتي' كشف صريح — يجب إضافته لقائمة العبارات المحظورة.
...
**Problem:** عبارات محظورة + كشف معالجة الصوت

**Suggested fix:**
> المطلوب: 'الزينگر بـ 9,000 🌷 توصيل أو استلام؟'
الحل: عبارات محظورة + كشف معالجة صوتية — يجب تنظيف الكل.
...
**Suggested fix:**
> المطلوب: 'الزينگر 9,000 د.ع 🌷 تريده؟'
الحل: بعد حذف 'تم تحليل الصورة.' تبقى 'هذا الزينگر' جملة غريبة — يجب إعادة البناء.
...
**Suggested fix:**
> المطلوب: 'عندنا زينگر وشاورما وبرگر مشروم 🌷 شتريد؟'
الحل: 'تم تحليل الصورة.' يجب إزالتها بالكامل مع ما يليها.
...
**Problem:** 'تم تحليل الصورة' في البداية — يكشف المعالجة

**Suggested fix:**
> المطلوب: 'آسفين 🌷 رقم الطلب؟'
الحل: 'تم تحليل الصورة وتشير إلى' — بعد حذف الجزء الأول تبقى جملة مكسورة.
...
**Suggested fix:**
> المطلوب: 'عندنا زينگر وشاورما وبرگر مشروم 🌷 شتريد؟'
الحل: كشف تحليل + محتوى قديم غير ذي صلة — البوت يجب إجابة بالمنيو الحالي فقط.
...
**Suggested fix:**
> المطلوب: 'الحلى ما متوفرة عندنا هسه 🌷'
الحل: 'تم تحليل الصورة' + معلومات خاطئة — مشكلتان.
...
**Suggested fix:**
> المطلوب: 'تمام 🌷 زينگر x1 وكولا — توصيل الكرادة كاش. تثبت؟'
الحل: 'وفقاً للسجلات' يجب إضافتها للقائمة المحظورة.
...
**Problem:** 'بناءً على سجلاتنا' — كشف قاعدة البيانات

**Suggested fix:**
> المطلوب: 'آخر طلب: زينگر x1 وكولا — توصيل الكرادة كاش 🌷 تريد نفسه؟'
الحل: 'بناءً على سجلاتنا' يجب إضافتها للقائمة المحظورة.
...
**Problem:** 'نعتذر على الإزعاج' عبارة محظورة

**Suggested fix:**
> المطلوب: 'الخدمة موقوفة حالياً 🌷'
...
| يحتاج تحسين | 4 (3%) |
| مرفوض | 16 (10%) |
| Weakest category | الرسائل الصوتية (7.0/10) |
| Strongest category | الشكاوى والدعم (8.8/10) |


## NUMBER 20B TASTE APPROVED

> Average 8.0/10, 10% rejected. Core order/complaint flows are strong. Fix the 16 rejected scenarios (mainly broken sentence starts after AI exposure stripping) in NUMBER 20C.
