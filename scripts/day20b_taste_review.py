...
def score_reply(s, final, issues):
    ...
    score_map = {
        ...
        "T11": (9,"ممتاز","ذكي — يعيد التوجيه للطلب بدون سؤال"),
        "T12": (8,"جيد","يعرض الأرخص فوراً — صحيح"),
        "T13": (9,"ممتاز","مباشر جداً"),
        "T14": (8,"جيد","جيد، لكن سؤال الإضافة قد يكون مبكراً"),
        "T15": (6,"يحتاج تحسين","20D: 'شنو تحب؟' — لا يجاوب على السؤال لكن نظيف بلا 'يرجى'"),
        # Order flow
        ...
        "C11": (9,"ممتاز","يعترف ويتصرف — لا يدافع"),
        ...
        "V03": (9,"ممتاز","20D: 'زينگر توصيل. وين أوصله؟' — بعد حذف طلبت، قصير وصحيح"),
        "V04": (8,"جيد","20D: 'زينگر استلام. الدفع كيف؟' — يؤكد الصنف والاستلام"),
        "V05": (9,"ممتاز","شكوى صوتية — رد صحيح بدون ذكر التحويل"),
        "V06": (9,"ممتاز","20D: قالب angry_complaint — بعد إزالة تم استقبال"),
        "V07": (10,"ممتاز","يستخدم الذاكرة تماماً — أفضل سيناريو"),
        "V08": (9,"ممتاز","20D: 'الزينگر بـ 9,000 د.ع 🌷' — قصير ومباشر بعد حذف استقبلنا"),
        "V09": (9,"ممتاز","20D: 'عندنا زينگر...' — بعد حذف وصلتني!"),
        ...
        "V14": (9,"ممتاز","يعطي الزبون الخيار — ذكي وعملي"),
        "V15": (8,"جيد","20C: 'زينگر x1. كاش. الكرادة. تثبت؟' — تأكيد طلب نظيف"),
        "V16": (9,"ممتاز","صادق بحدوده + يعرض التصعيد فوراً"),
        "V17": (7,"جيد","20D: محتوى صحيح، لا قالب خاطئ بعد إزالة للاستفسار من المحظور"),
        ...
        "I15": (9,"ممتاز","20D: قالب image_menu 'وصلت الصورة 🌷 شتحب من المنيو هذا؟' — بعد اكتشاف AI exposure"),
        "I16": (9,"ممتاز","مقارنة سريعة للصنفين"),
        "I17": (9,"ممتاز","سعر + بيع متقاطع خفيف"),
        "I18": (7,"جيد","20D: قالب image_product — أفضل من كشف AI"),
        "I19": (8,"جيد","صادق بحدود المعرفة، يعرض الطلب"),
        ...
        "S09": (9,"ممتاز","يوجه للخاص بدلاً من الإجابة العامة"),
        "S10": (9,"ممتاز","يحافظ على الخصوصية"),
        "S11": (9,"ممتاز","يسأل عن المنطقة مباشرة"),
        "S12": (9,"ممتاز","ريل سعر → مباشر"),
        "S13": (9,"ممتاز","ريل طلب → يبدأ التدفق"),
        "S14": (8,"جيد","وصف الصنف + سؤال الطلب"),
        "S15": (9,"ممتاز","شكوى الريل → للخاص"),
        "S16": (9,"ممتاز","منيو كامل بشكل منظم"),
        "S17": (9,"ممتاز","عنوان للخاص — صحيح"),
        "S18": (9,"ممتاز","تحويل للخاص للطلب"),
        "S19": (8,"جيد","يعرض الأرخص في الأبوست"),
        "S20": (9,"ممتاز","قالب الشكر"),
        "S21": (8,"جيد","صادق + يعرض بديلاً"),
        "S22": (8,"جيد","20D: 'هذا متوفر 🌷 تريد تطلب؟' — بعد حذف نعم والـDM"),
        "S23": (9,"ممتاز","يسرد المنيو بشكل طبيعي"),
        "S24": (9,"ممتاز","يبدأ تدفق الطلب"),
        "S25": (9,"ممتاز","يحوّل للخاص للطلب"),
        # Memory
        "M01": (10,"ممتاز","نفس الطلب السابق — يستخدم الذاكرة تماماً"),
        "M02": (9,"ممتاز","20C: 'طلبك السابق كان زينگر x1 وكولا. تريد نفسه؟' — طبيعي وصادق"),
        "M03": (9,"ممتاز","لا يسأل عن العنوان الموجود"),
        "M04": (9,"ممتاز","يخاطب بالاسم ويسأل عن التفضيل المعتاد"),
        "M05": (9,"ممتاز","مرحباً أحمد 🌷 كالعادة توصيل للكرادة؟"),
        "M06": (10,"ممتاز","يسرد آخر طلب بالكامل ويسأل"),
        "M07": (9,"ممتاز","20C: 'آخر طلب كان زينگر x1 وكولا توصيل الكرادة كاش 🌷' — بيانات محفوظة نظيفة"),
        ...
        "M11": (9,"ممتاز","تمام، أوصله للكرادة مثل آخر مرة؟"),
        "M12": (9,"ممتاز","تمام 🌷 كاش مثل دايماً؟"),
        ...
        "B02": (8,"جيد","20D: قالب blocked_subscription بعد override للـintent"),
        "B03": (8,"جيد","رسالة واضحة"),
        "B04": (8,"جيد","صادق لكن قليل الدفء"),
        "B05": (8,"جيد","يوجّه للمطعم مباشرة"),
        "B06": (7,"جيد","خطأ النظام بشكل طبيعي"),
        "B07": (8,"جيد","صادق"),
        "B08": (8,"جيد","ساعات الدوام — واضح"),
        "B09": (9,"ممتاز","يحدد النطاق بدون إهانة"),
        "B10": (9,"ممتاز","أفهم إحباطك 🌷 شنو المشكلة؟"),
    }
