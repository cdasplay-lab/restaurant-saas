...
def score_reply(s, final, issues):
    ...
    score_map = {
        ...
        "T02": (5,"يحتاج تحسين","بعد حذف 'بالتأكيد' ويمكنني مساعدتك' تبدأ الجملة بـ '! في معرفة المنيو' — مكسورة"),
        "T03": (5,"يحتاج تحسين","بعد حذف 'بالتأكيد' يبقى '! الزينگر' — يبدأ بعلامة تعجب"),
        ...
        "O03": (4,"مرفوض","سؤالان في رد واحد: الكمية + نوع التوصيل"),
        "O04": (9,"ممتاز","يسأل عن العنوان فقط"),
        "O05": (9,"ممتاز","سؤال واحد: توصيل أو استلام"),
        "O06": (5,"يحتاج تحسين","بعد حذف بالتأكيد يبقى '! أريد عنوانك' — يبدأ بعلامة تعجب"),
        ...
        "V03": (3,"مرفوض","بعد حذف الجملة الأولى يبدأ الرد بـ '. طلبت' — مكسور"),
        "V04": (3,"مرفوض","نفس مشكلة V03: '. الدفع' — بداية مكسورة"),
        "V05": (9,"ممتاز","شكوى صوتية — رد صحيح بدون ذكر التحويل"),
        "V06": (3,"مرفوض","عبارات محظورة في الرد الصوتي الغاضب"),
        "V07": (10,"ممتاز","يستخدم الذاكرة تماماً — أفضل سيناريو"),
        "V08": (5,"يحتاج تحسين","'استقبلنا استفسارك' — يلمح للمعالجة"),
        ...
        "V15": (4,"مرفوض","'تم معالجة طلبك الصوتي' — يكشف المعالجة"),
        ...
        "V20": (3,"مرفوض","عبارات محظورة + كشف معالجة الصوت"),
        # Images
        "I01": (3,"مرفوض","'تم تحليل الصورة' — لا يزال موجوداً بعد الحذف الجزئي"),
        "I02": (9,"ممتاز","صورة غير واضحة — سؤال طبيعي"),
        "I03": (3,"مرفوض","'تم تحليل الصورة' — لا يزال موجوداً"),
        ...
        "I08": (3,"مرفوض","'تم تحليل الصورة' في البداية — يكشف المعالجة"),
        ...
        "I15": (3,"مرفوض","'تم تحليل الصورة' — كشف المعالجة + محتوى غير ذي صلة"),
        "I16": (9,"ممتاز","مقارنة سريعة للصنفين"),
        "I17": (9,"ممتاز","سعر + بيع متقاطع خفيف"),
        "I18": (4,"مرفوض","'تم تحليل الصورة' + معلومات خاطئة"),
        ...
        "M02": (4,"مرفوض","'وفقاً للسجلات' — عبارة آلية تكشف النظام"),
        ...
        "M07": (3,"مرفوض","'بناءً على سجلاتنا' — كشف قاعدة البيانات"),
